...
import { CheckCircle2, MapPin, Calendar, Clock, Ticket, ArrowRight } from 'lucide-react'
        ...
        <Card className="overflow-hidden border-2">
          ...
          <div className="px-6 pb-6">
            <p className="text-xs text-center text-muted-foreground">
              Present this reference at the venue. A confirmation email has been sent to your registered email.
            </p>
          </div>
        </Card>
      </motion.div>
